  ...
  return (
    <div id="home" className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-6">
        ...
        <Link href="#services">
          <button className="px-8 py-3 mt-8 text-lg font-semibold bg-gradient-to-r from-[#0052D4] via-[#4364F7] to-[#6FB1FC] rounded-full shadow-md hover:scale-105 transition-transform duration-300">
            Explore Our Work
          </button>
        </Link>
      </div>
